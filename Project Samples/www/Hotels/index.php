...
<div id="templatemo_header_wrapper">
	...
	<div id="site_title"></div>
        ...
        <div class="clear">
          <h1 class="clear"><strong><strong><img src="images/12570097-currency-brl-rate-concept-symbol-button-on-white-background.jpg" alt="sdfgh" width="399" height="94" longdesc="../../../Users/100RB/Pictures/12570097-currency-brl-rate-concept-symbol-button-on-white-background.jpg" /></strong> Best Restaurant Locator</strong></h1>
      </div>
...
<div id="templatemo_main">
	<div class="half left">
        ...
        <div class="half right">
            <h2>Welcome To BRL</h2>
			<p><font color="#CC0000"><strong>Best Restaurant Locator</strong></font></p>
<p><font color="#FFFFFF">Top 25 trending restaurants in this city are selected.cuisine selected &amp; age on basis of user behavior on BRL for show the list of best hotels. These user actions include a weighted average of:</font></p>
			<p><font color="#999999"><ul>
			  <li>Pageviews of a restaurant on<strong> BRL</strong>website and mobile apps</li>
			  <li>Organic searches for the restaurant</li>
			  <li>Number of reviews (with 4 &amp; 5 stars) and votes for a restaurant</li>
			  <li>Average time spent by a user on a restaurant's page</li>
		  </ul></font></p>
        </div>  
        ...
        <div class="col one_third">
            ...
            <?php
                ...
                mysql_select_db ("hotels_in_metro");
                $select="hotels_in_metro";
