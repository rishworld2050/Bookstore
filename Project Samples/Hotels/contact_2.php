...
$formproc_obj->setFormDBLogin('localhost','root','','hotels_in_metro1');
...
$validator->addValidation("username","required","Please fill in user_name");
$validator->addValidation("username","alnum","The input for user_name should be a valid alpha-numeric value");
$validator->addValidation("username","unique","This value is already submitted");
$validator->addValidation("username","maxlen=30","The length of the input for user_name should not exceed 30");
$validator->addValidation("username","minlen=8","The length of the input for user_name should be at least 8.");
...
$s_db_handler->AddField('username','VARCHAR(250)');
...
$tupage->SetRedirURL('http://localhost/hotels/thankyou.html');
