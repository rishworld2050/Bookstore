...
define('STRING_GREETINGS', '<h1>Welcome to My Online BookStore!</h1>');
...
define('STRING_ORDER_PLACED', '<div align="center"><h1>Thank you for you order!</h1><h3>Kindly check yor mailbox (the one provided in the details) for the order details</h3></div>');
